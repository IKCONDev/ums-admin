...
public class OrgController {
	...
	public ResponseEntity<?> deleteOrgByOrgId(@PathVariable("orgId") Integer orgId){
		...
		try {
			...
			log.info("OrgController.deleteOrgByOrgId() exited with exception : Exception occured while deleting user.");
